...
if __name__ == "__main__":
    ...
    output_bin_qann_dir = f"/data1/kang_you/output_bin_qann_{args.model}_{args.dataset}_w{args.WeightBit}_a{args.ActBit}/"
    ...
    output_bin_snn_dir = f"/data1/kang_you/output_bin_snn_{args.model}_{args.dataset}_w{args.WeightBit}_a{args.ActBit}_T{args.maxTimeStep}/"
    if args.rank == 0:
