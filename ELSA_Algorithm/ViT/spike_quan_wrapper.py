...
from spike_quan_layer import MyQuan,IFNeuron,LLConv2d,LLLinear,ORIIFNeuron,QAttention,SAttention,Spiking_LayerNorm,QuanConv2d,QuanLinear,Attention_no_softmax,ORIIFNeuron,save_module_inout
    ...
    def _record_inout(self,model):
        ...
        for name, child in children:
            ...
            if isinstance(child, SAttention):
                ...
                child = save_module_inout(m=child,T=self.T)
                is_need = True
            if not is_need:            
