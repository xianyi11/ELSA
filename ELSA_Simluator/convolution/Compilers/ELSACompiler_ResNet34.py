...
def run_resnet34_vary_t(
    ...
    return run_unified_elisa_pipeline(
        ...
        search_input_simple="SearchInput_ResNet34_a4w4_with_Noc_simple.pth",
        calculate_info_pth=f"calculateInfoConv_ResNet34_a4w4_with_Noc_T={ts}.pth",
        communication_traffic_pth=f"calculateInfoConv_ResNet34_a4w4_communicationtraffic_T={ts}.pth",
        column_finish_pth=f"columnFinishCyclePerlayer_ResNet34_a4w4_with_Noc_T={ts}.pth",
        search_input_final=f"SearchInput_ResNet34_a4w4_with_Noc__T={ts}.pth",
    )
