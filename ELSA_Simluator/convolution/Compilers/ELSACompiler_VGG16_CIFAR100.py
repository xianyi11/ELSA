...
def run_vgg16_cifar100_vary_t(
    ...
    return run_unified_elisa_pipeline(
        ...
        search_input_simple="SearchInput_VGG16_CIFAR100_a4w4_with_Noc_simple.pth",
        calculate_info_pth="calculateInfoConv_VGG16_CIFAR100_a4w4_with_NoC.pth",
        communication_traffic_pth="calculateInfoConv_VGG16_CIFAR100_a4w4_communicationtraffic.pth",
        column_finish_pth="columnFinishCyclePerlayer_VGG16_CIFAR100_a4w4_with_Noc.pth",
        search_input_final="SearchInput_VGG16_CIFAR100_a4w4_with_Noc.pth",
