...
def run_resnet18_vary_t(
    ...
    return run_unified_elisa_pipeline(
        ...
        search_input_simple="SearchInput_ResNet18_a4w4_with_Noc_simple.pth",
        calculate_info_pth="calculateInfoConv_ResNet18_a4w4_with_Noc_1.pth",
        communication_traffic_pth="calculateInfoConv_ResNet18_a4w4_communicationtraffic_1.pth",
        column_finish_pth="columnFinishCyclePerlayer_ResNet18_a4w4_with_Noc_1.pth",
        search_input_final="SearchInput_ResNet18_a4w4_with_Noc_1.pth",
    )
