...
class VSACompiler(nn.Module):
    def __init__(self, networkDir, connection_path, mapping_path, tranOccupy_path):
    ...
    def collectLayers(self):
        ...
        for i, name in enumerate(list(connection.keys())):
            ...
            if curlayerParam.type == 'conv':
                ...
                self.kernelStridePerLayer[curlayerParam.name] = [kernelSize,curlayerParam.input.shape[-1]//curlayerParam.output.shape[-1]]
...
def run_vgg16_cifar10dvs_vary_t(
    datapath,
    connectionpath,
    mappingpath,
    occupyPath,
    ...
    return run_unified_elisa_pipeline(
        ...
        search_input_simple="SearchInput_VGG16_CIFAR10DVS_a4w4_with_Noc_simple.pth",
        calculate_info_pth="calculateInfoConv_VGG16_CIFAR10DVS_a4w4_with_NoC.pth",
        communication_traffic_pth="calculateInfoConv_VGG16_CIFAR10DVS_a4w4_communicationtraffic.pth",
        column_finish_pth="columnFinishCyclePerlayer_VGG16_CIFAR10DVS_a4w4_with_Noc.pth",
        search_input_final="SearchInput_VGG16_CIFAR10DVS_a4w4_with_Noc.pth",
        use_input_time_steps=True,
    )
