...
class VSACompiler(nn.Module):
    ...
    def collectLayers(self):
        ...
        for i, name in enumerate(fileHandler):            
...
def run_resnet101_vary_t(
    ...
    return run_unified_elisa_pipeline(
        ...
        search_input_simple="SearchInput_ResNet101_a4w4_with_Noc_simple.pth",
        calculate_info_pth="calculateInfoConv_ResNet101_a4w4_with_Noc.pth",
        communication_traffic_pth="calculateInfoConv_ResNet101_a4w4_communicationtraffic.pth",
        column_finish_pth="columnFinishCyclePerlayer_ResNet101_a4w4_with_Noc.pth",
        search_input_final="SearchInput_ResNet101_a4w4_with_Noc.pth",
    )
